...
<body>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="dropdown" style="color:#ffffff">
                    <button class="btn btn-default dropdown-toggle" type="button" value="Sign in/up" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            ...
            <div class="col-lg-12 col-md-6 col-xs-6">
                    <h1 class="page-header" style="background-color:#00caff; color:white;">Success Stories</h1>
                </div>
    ...
    <div id="theModal3" class="modal fade text-center">
        <div class="modal-dialog">
            <div class="modal-content">
            </div>
        </div>
    ...
    <div class="container">
        <h1 style="background-color:#00caff; color:white;">Opportunities are waiting for you!</h1>
                ...
                <div class="col-md-12" id="carousel-bounding-box">
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                           <div class="active item" data-slide-number="0" onclick="window.location='http://google.com';">
